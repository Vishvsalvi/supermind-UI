...
export default function ChatInterface() {
  ...
  return (
    ...
    <Card className="w-full max-w-4xl h-[80vh] flex flex-col bg-neutral-900">
        ...
        >
              ...
              >
                <ReactMarkdown
                  ...
                  components={{
                    ...
                    code: ({ node, ...props }) => <code className="bg-yellow-200 rounded px-1 py-0.5 text-sm" {...props} />,
                    pre: ({ node, ...props }) => <pre className="bg-yellow-200 rounded p-2 mb-2 overflow-x-auto" {...props} />,
                    a: ({ node, ...props }) => <a className="text-yellow-700 underline" {...props} />,
                    blockquote: ({ node, ...props }) => <blockquote className="border-l-4 border-yellow-300 pl-4 italic" {...props} />,
                  }}
                >
                  {message.content}
                </ReactMarkdown>
          ...
          {isTyping && (
            <div className="text-left">
              <div className="inline-block p-3 rounded-lg bg-neutral-200 text-neutral-900">
                <div className="flex items-center">
                  {[...Array(3)].map((_, i) => (
                    <span
                      key={i}
                      className="h-2 w-2 bg-neutral-900 rounded-full mr-1 animate-bounce"
                      style={{
      ...
      <CardFooter>
        <form onSubmit={handleSubmit} className="flex w-full space-x-2">
          <Input
            ...
            className="flex-grow bg-white text-neutral-900 placeholder-neutral-500"
          />
          <Button type="submit" disabled={isTyping} className="bg-emerald-500 text-white hover:bg-emerald-600">
